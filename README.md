...
- Netlify Scheduled Function ile 30 dakikada bir kontrol edilen zamanlanmış yayın kuyruğu
- Yayından 2 gün sonra Supabase Storage görsellerini temizleyen günlük bakım fonksiyonu
...
## Zamanlanmış Yayın Kontrolü

Netlify Scheduled Function `*/30 * * * *` cron ifadesiyle 30 dakikada bir çalışır. Bu yapı altyapıyı gereksiz yormaz; ancak 17:45 veya 23:45 gibi ara saatlerde planlanan gönderiler bir sonraki 30 dakikalık kontrolde yayınlanabilir.

## Medya Temizliği

Yayımlanmış gönderilerin Supabase Storage görselleri yayından 2 gün sonra günlük bakım fonksiyonuyla silinir. Gönderi geçmişi, caption, tarih, saat, durum ve Instagram linki korunur. Fonksiyon Netlify cron ile `0 0 * * *` çalışır; bu Türkiye saatiyle yaklaşık 03:00'e denk gelir.
